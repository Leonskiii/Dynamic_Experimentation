...
export class Nouns extends Words {
    static static_words = [
        ...
        "point",                "poison",               "pollution",            "corn",                 "porter",
        ...
        "or",                   "so",                   "to",                   "up",                   "us",
        "we",                   "an",                   "as",                   "ox",                   "ax",
        "accomplishment",       "acknowledgement",      "administration",       "advertisement",        "approximately",
        "circumstances",        "collaboration",        "communication",        "concentration",        "consideration",
        "contamination",        "contradiction",        "conversation",         "determination",        "disappointment",
        "discrimination",       "documentation",        "embarrassment",        "establishment",        "exaggeration",
        "experimentation",      "implementation",       "improvisation",        "infrastructure",       "interpretation",
        "investigation",        "misunderstanding",     "multiplication",       "neighbourhood",        "nevertheless",
        "nourishment",          "opportunities",        "organization",         "participation",        "perseverance",
        "photographer",         "precipitation",        "presentation",         "prioritization",       "pronunciation",
        "qualification",        "reconstruction",       "refrigerator",         "reinforcement",        "representation",
        "responsibility",       "transformation",       "transportation",       "understanding",        "approximately",
        "butterfly",            "caterpillar",          "celebration",          "championship",         "comfortable",
        "complicated",          "confidence",           "construction",         "contribution",         "conversation",
        "cooperation",          "corporation",          "countryside",          "creativity",           "curiosity",
        "declaration",          "dedication",           "description",          "destination",          "dictionary",
        "difficulty",           "directions",           "disappearance",        "education",            "electricity",
        "emergency",            "encouragement",        "entertainment",        "environment",          "equipment",
        "examination",          "expectation",          "explanation",          "exploration",          "expression",
        "foundation",           "friendship",           "generation",           "graduation",           "greenhouse",
        "halloween",            "happiness",            "helicopter",           "housework",            "hurricane",
        "illustration",         "imagination",          "immigration",          "independence",         "indication",
        "information",          "ingredient",           "inspiration",          "institution",          "instruction",
        "intelligence",         "introduction",         "journalism",           "laboratory",           "leadership",
        "legislature",          "limitation",           "literature",           "management",           "manufacture",
        "mathematics",          "measurement",          "medication",           "meditation",           "microscope",
        "motivation",           "nationality",          "navigation",           "negotiation",          "networking",
        "nomination",           "notification",         "occupation",           "operation",            "opposition",
        "orientation",          "origination",          "permission",           "philosophy",           "population",
        "possibility",          "prediction",           "preparation",          "prevention",           "production",
        "profession",           "progression",          "projection",           "promotion",            "proportion",
        "protection",           "publication",          "recognition",          "recommendation",       "recreation",
        "reflection",           "registration",         "regulation",           "rehabilitation",       "relaxation",
        "reproduction",         "resignation",          "resolution",           "restriction",          "revolution",
        "satisfaction",         "scholarship",          "separation",           "simulation",           "situation",
        "specification",        "stimulation",          "subscription",         "supervision",          "sustainability",
        "technology",           "temperature",          "transaction",          "translation",          "transmission",
        "unemployment",         "vaccination",          "validation",           "vegetation",           "visualization",
        "vocabulary",           "volunteering",         "vulnerability",        "warehouse",            "wonderland",
    ];
